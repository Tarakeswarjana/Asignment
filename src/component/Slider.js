...
function Slider() {
    ...
    return (
        ...
        >
            <SwiperSlide>  <div className='flex gap-3 justify-between'><p>jhfjyrekfhkjhewuywiuykejhgejhgiyeiuwrhgkheguyugyerkhgkerjhkj</p><img src={img1} className='bg-[#bab8b8]' /> </div>        </SwiperSlide>
